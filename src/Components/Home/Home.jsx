...
export default function Home() {
  ...
  return (
    <>
      ...
      <section ref={ourstoryRef} className={`${style.ourstory}`}>
        <h3 className={`${ourstoryVisible ? style.storyRevealVisible : style.storyRevealHidden}`}>"Born from the desire to gite warmth in — every <br /> form. "</h3>
        <div className={`${style.ourstory_link} ${ourstoryVisible ? style.storyRevealVisible : style.storyRevealHidden}`} style={{ transitionDelay: '0.3s' }}>
